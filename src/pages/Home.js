...
export default function Home() {
  ...
  return (
        <div id='home' className={`h-100vh pt-20 lg:pt-0 flex flex-col overflow-hidden ${mode}`}>
            ...
            <div className='hidden md:flex animate-bounce gap-2 items-center absolute bottom-4 right-4'>
